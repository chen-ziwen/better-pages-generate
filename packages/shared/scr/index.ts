...
const getRouteExports = (content: string) => ({
  ...
  loader: /^export\s+(var|let|const|function|async function)\s+Loader\W/gm.test(content),
  action: /^export\s+(var|let|const|function|async function)\s+Action\W/gm.test(content),
  pending: /^export\s+(var|let|const|function|async function)\s+Pending\W/gm.test(content),
  catch_: /^export\s+(var|let|const|function)\s+Catch\W/gm.test(content),
  handle: /^export\s+(var|let|const|function)\s+Handle\W/gm.test(content),
})
